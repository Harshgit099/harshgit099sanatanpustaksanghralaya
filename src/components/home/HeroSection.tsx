    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-8 mt-8 sm:mt-0 opacity-0 animate-fade-in">
          ...
          <h1 className="font-display text-4xl sm:text-5xl lg:text-7xl font-bold mb-4 opacity-0 animate-fade-in-up animation-delay-100">
            <span className="gradient-text">Sanatan Pustak Sanghralaya</span>
          </h1>
